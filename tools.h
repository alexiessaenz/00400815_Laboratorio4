...
void leerMallayCondiciones(mesh &m){
    char filename[14];
    ifstream file;
    float l, tao, kappa, lambda, epsilon, psi, alfa, delta, eta;
    ...
    file >> l >> tao >> kappa >> lambda >> epsilon >> psi >> alfa >> delta >> eta;
    file >> nnodes >> neltos >> ndirich_u >> ndirich_p;


    m.setParameters(l, tao, kappa, lambda, epsilon, psi, alfa, delta, eta);
