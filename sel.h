void createLocalA(Matrix &A,mesh m){
    float tao = m.getParameter(TAO);
    A.at(0).at(0) += -tao / 8; A.at(0).at(1) += tao / 8;
    A.at(1).at(0) += -tao / 8; A.at(1).at(1) += tao / 8;
}
...
void createLocalQ(Matrix &Q,mesh m){
    ...
    Q.at(0).at(0) += epsilon / l; Q.at(0).at(1) += -epsilon / l;
    Q.at(1).at(0) += -epsilon / l; Q.at(1).at(1) += epsilon / l;
}
