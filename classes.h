...
enum parameters {ELEMENT_LENGTH,TAO,KAPPA,LAMBDA,EPSILON,PSI,ALFA,DELTA,ETA};
...
public:
    void setParameters(float l, float tao, float kappa, float lambda, float eps, float psi, float alfa, float delta, float eta){
